	...
	try {
		...
		// Check if email already exists
						$d = date("Y-m-d"); //Year - Month - Day
							...
							$result = mysqli_query($con, "UPDATE post SET subject='$sublist',class='$classlist',medium='$mediumlist',location='$listdistrict',p_university='$_POST[p_university]',deadline='$_POST[deadline]', post_time='$posttime' WHERE id='$pstid'");
				...
				?>
			  	...
			  	<div class="itemrow">
			  			...
			  			<div style="width: 80%; float: left;">
			  				<div class="divp35"><input <?php $sub1=strstr($sub, "Bangla"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Bangla"><span>Hindi</span></div>
							...
							<div class="divp35"><input <?php $sub1=strstr($sub, "Religion"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Religion"><span>DBMS</span></div>
							...
							<div class="divp35"><input <?php $sub1=strstr($sub, "Higher Math"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Higher Math"><span>Higher Maths</span></div>
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
								<div class="divp35"><input <?php $medium1=strstr($medium, "Bangla"); if($medium1 != '') echo 'checked'; ?> type="checkbox" name="medium_list[]" value="Bangla"><span>Hindi</span></div>
					...
					<div class="itemrow">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="Nawas Shareef University">Cochin University</option>
							  <option value="Brac University">Patna University</option>
							  <option value="Dhaka Univesity">Assam Univesity</option>
							</select>
							</div>
						</div>
					<div class="itemrow">
