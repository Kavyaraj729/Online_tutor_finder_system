...
if (isset($_POST['updatetutioninfo'])) {
	...
	try {
				if(($user == $_REQUEST['uid']) && ($utype_db == "teacher"))
				{
					...
					if($result4 = $con->query("INSERT INTO tutor (t_id,prefer_sub,class,medium,inst_name,prefer_location) VALUES ('$user','$sublist','$classlist','$mediumlist','$uinst_db', '$listdistrict')")){
...
<div class="class">
	...
	<div class="cls">
			...
			<div class="divp35"><input type="radio" name="class_list[]" value="Eight-Nine"><span>Eight</span></div>
			<div class="divp35"><input type="radio" name="class_list[]" value="Tenth"><span>Nine-Ten</span></div>
...
<div class="location">
	...
	<div class="lc">
			...
			<div class="divp35"><input type="radio" name="list_district[]" value="Allepey"><span>Allepey</span></div>
			...
			<div class="divp35"><input type="radio" name="list_district[]" value="kollam"><span>Kollam</span></div>
			<div class="divp35"><input type="radio" name="list_district[]" value="kottayam"><span>Kottayam</span></div>
