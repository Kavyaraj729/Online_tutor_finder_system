...
<body style="  background:fixed url(./image/backgr.jpg);background-size: 100%;" class="">
<div class="nbody">
			<?php
				echo '<center><div class="main"> 
				<form class="form" action="" method="post"><h1 class="warning" style="color:yellow;  padding-top: 15px; font-size: 25px;">';	
				...
				if(isset($success_message)) {echo $success_message;}
					...
					<input type="number" name="mobile" id="name"  placeholder="Enter 10 digit Phone number" value="'.$u_mobile.'" required>
